...
def prepare_data():
    ...
    label_names = ['dark', 'light']
    label_count = len(label_names)
    # train_files = ['data_batch_%d' % d for d in range(1, 6)]
    train_files = ['data_batch_%d' % d for d in range(1)]
    # train_data, train_labels = load_data(train_files, data_dir, label_count)
    # test_data, test_labels = load_data(['wood_test_batch'], data_dir, label_count)
    train_data, train_labels = load_data(['wood_train_batch'], data_dir, label_count)
    test_data, test_labels = load_data(['wood_test_batch'], data_dir, label_count)
